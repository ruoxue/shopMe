...
const loginin = "/dev-api/auth/religionlogin"; //
...
const religionNotice = "/dev-api/religion/religionNotice/appList"
const religionDayCheck = "/dev-api/religion/religionDayCheck/appList"
const religionInfoManager = "/dev-api/religion/religionInfoManager/appList"
const religionLearnAssist = "/dev-api/religion/religionLearnAssist/appList"
const religionBuildingList = "/dev-api/religion/api/religionBuilding/list"
const religionBuilding = "/dev-api/religion/api/religionBuilding"
...
const loadImg = (ret) => {
	...
	uni.chooseImage({
		...
		success: (r) => {
			...
			uni.uploadFile({
				url: '/dev-api/file/upload', //仅为示例，非真实的接口地址
...
async function getDics(dict) {
	return await getApp().useDict(dict);
...
const fetch = (ret, address, param, method = 'GET') => {
	...
	var header = {
		...
		'Authorization': infoJ.access_token == undefined ? "" : infoJ
			.access_token //'921555d3ce6a3947bf7feae7f2bc719b'//uni.getStorageSync('token')
	};
