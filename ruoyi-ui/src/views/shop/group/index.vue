...
<script>
import { listGroup, getGroup, delGroup, addGroup, updateGroup } from "@/api/shop/group";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('shop/group/export', {
        ...this.queryParams
