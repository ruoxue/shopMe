<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="顺序号" prop="seqNumber">
        <el-input
          v-model="queryParams.seqNumber"
          placeholder="请输入顺序号"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="门牌号" prop="lastDetail">
        <el-input
          v-model="queryParams.lastDetail"
          placeholder="请输入门牌号"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="顺序号" prop="seqNumber">
          <el-input v-model="form.seqNumber" placeholder="请输入顺序号" />
        </el-form-item>
        <el-form-item label="省" prop="province">
        ...
        <el-form-item label="门牌号" prop="lastDetail">
          <el-input v-model="form.lastDetail" placeholder="请输入门牌号" />
        </el-form-item>
        <el-form-item label="乐观锁" prop="revision">
