  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="证书" prop="appCertContent">
          <el-input v-model="form.appCertContent" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="" prop="alipayPublicCertContent">
        ...
        <el-form-item label="同步回调地址" prop="returnUrl">
          <el-input v-model="form.returnUrl" placeholder="请输入同步回调地址" />
        </el-form-item>
      </el-form>
