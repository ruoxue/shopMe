<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="开票设置ID" prop="invoiceTplId">
        <el-input
          v-model="queryParams.invoiceTplId"
          placeholder="请输入开票设置ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['shop:buyerOrder:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['shop:buyerOrder:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['shop:buyerOrder:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['shop:buyerOrder:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="buyerOrderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="开票设置ID" align="center" prop="invoiceTplId" />
      <el-table-column label="订单留言备注" align="center" prop="leaveComment" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="优惠金额" prop="couponPrice">
          <el-input v-model="form.couponPrice" placeholder="请输入优惠金额" />
        </el-form-item>
        <el-form-item label="应付金额" prop="payablePrice">
        ...
        <el-form-item label="开票设置ID" prop="invoiceTplId">
          <el-input v-model="form.invoiceTplId" placeholder="请输入开票设置ID" />
        </el-form-item>
        <el-form-item label="订单留言备注" prop="leaveComment">
          <el-input v-model="form.leaveComment" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="乐观锁" prop="revision">
...
<script>
import { listBuyerOrder, getBuyerOrder, delBuyerOrder, addBuyerOrder, updateBuyerOrder } from "@/api/shop/buyerOrder";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listBuyerOrder(this.queryParams).then(response => {
        this.buyerOrderList = response.rows;
    ...
    handleUpdate(row) {
      ...
      getBuyerOrder(orderId).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.orderId != null) {
            updateBuyerOrder(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addBuyerOrder(this.form).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('shop/buyerOrder/export', {
        ...this.queryParams
      }, `buyerOrder_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
