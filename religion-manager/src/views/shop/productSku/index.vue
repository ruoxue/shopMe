    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['shop:productSku:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['shop:productSku:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['shop:productSku:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['shop:productSku:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="productSkuList" @selection-change="handleSelectionChange">
...
<script>
import { listProductSku, getProductSku, delProductSku, addProductSku, updateProductSku } from "@/api/shop/productSku";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listProductSku(this.queryParams).then(response => {
        this.productSkuList = response.rows;
    ...
    handleUpdate(row) {
      ...
      getProductSku(id).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('shop/productSku/export', {
        ...this.queryParams
