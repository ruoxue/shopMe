    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['shop:PAYMENT:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['shop:PAYMENT:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listPAYMENT, getPAYMENT, delPAYMENT, addPAYMENT, updatePAYMENT } from "@/api/shop/PAYMENT";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getPAYMENT(revision).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('shop/PAYMENT/export', {
        ...this.queryParams
