...
<script>
import { listTitle, getTitle, delTitle, addTitle, updateTitle } from "@/api/shop/title";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('shop/title/export', {
        ...this.queryParams
