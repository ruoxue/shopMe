...
<script>
import { listOption, getOption, delOption, addOption, updateOption } from "@/api/shop/option";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('shop/option/export', {
        ...this.queryParams
