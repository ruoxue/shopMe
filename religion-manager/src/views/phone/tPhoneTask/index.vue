<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tPhoneTaskList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="下载" align="center" prop="url" >
        <template slot-scope="scope">
      ...
      <el-table-column label="仅系统内生成" align="center" prop="inSystem">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.global_status" :value="scope.row.inSystem"/>
        </template>
      </el-table-column>
...
:label="parseInt(dict.value)"
       ...
       :label="parseInt(dict.value)"
        ...
        <el-form-item label="范围" prop="scope">
          <el-input v-model="form.scope" placeholder="请输入范围[13000000000-13000000001]" />
        </el-form-item>
...
export default {
  name: "TPhoneTask",
  dicts: ['global_status', 'task_status'],
  data() {
    return {
      // 遮罩层
      loading: true,
